...
int main ()
{
    ...
    string purpose =
    "Given its value, this program calculates the property tax of a property.";
    ...
    //To find the tax amount, divide the assessedValue by 100 (each $100 is
    //taxed by 64 cents) and multiply the answer by 64 cents.
